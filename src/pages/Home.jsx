...
/* ================================================================
   ...
   ================================================================ */
const ICON_MAP = {
  Buildings, ShieldCheck, Handshake, Briefcase, Users, Lock,
};


/* ================================================================
   1. HERO — Authoritative, Navy & Gold
   ================================================================ */
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-navy-950/85 via-transparent to-navy-950/60 z-[1]" />
      </motion.div>
      ...
      {/* Gold accent lines — both edges */}
      <div className="absolute top-[18%] left-0 w-16 sm:w-24 h-[1px] bg-gold-500/50 z-20" />
      <div className="absolute bottom-[20%] right-0 w-16 sm:w-24 h-[1px] bg-gold-500/30 z-20" />
      ...
      <div className="hidden lg:flex absolute right-8 top-1/2 -translate-y-1/2 z-20">
        <span className="text-white/10 text-[10px] uppercase tracking-[0.4em] font-heading" style={{ writingMode: 'vertical-rl' }}>
          Kantor &amp; Immerman &mdash; Est. 1962
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['CORPORATE LAW', 'LITIGATION', 'PROPERTY LAW', 'LABOUR LAW', 'FAMILY LAW', 'COMMERCIAL CONTRACTS', 'DISPUTE RESOLUTION', 'LEGAL ADVISORY'];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              A LEGACY OF<br />
              <span className="text-gold-500">JUSTICE</span><br />
              SINCE 1962.
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg">
              Kantor & Immerman was established in 1962, during a pivotal era in Zimbabwe's history.
              From our earliest days, we committed to providing legal services of the highest calibre
              — services that would stand up not just in court, but in the annals of legal precedent.
            </p>
            <p className="text-white/40 text-sm leading-relaxed max-w-lg">
              Through independence, economic transformation, and constitutional reform, our firm has been
              at the centre of Zimbabwe's legal landscape. We have represented individuals, corporations,
              and government institutions in matters that have shaped the nation's jurisprudence. Today,
              with over 40 legal professionals across six practice areas, we continue to set the standard.
            </p>
            ...
            <div className="flex gap-8 sm:gap-12">
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">1962</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Established</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">5K+</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Cases Won</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">40+</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Practitioners</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Kantor & Immerman legal heritage"
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-gold-500 text-white p-4 sm:p-6 shadow-2xl">
                <div className="text-center">
                  <div className="font-heading text-2xl sm:text-3xl font-bold leading-none">60+</div>
                  <div className="text-[10px] sm:text-xs uppercase tracking-wider font-semibold mt-1 text-white/80">
                    Years of<br />Legal Authority
                  </div>
                </div>
              </div>
            </div>
...
/* ================================================================
   5. LANDMARK CASES — Horizontal Scroll
   ================================================================ */
function LandmarkCases() {
  const containerRef = useRef(null);
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              SIX DECADES OF<br />
              <span className="text-gold-500">LEGAL</span> AUTHORITY
            </h2>
...
function StatsBand() {
  ...
  const stats = [
    { number: '60', suffix: '+', label: 'Years Established' },
    { number: '5000', suffix: '+', label: 'Cases Won' },
    { number: '40', suffix: '+', label: 'Legal Professionals' },
